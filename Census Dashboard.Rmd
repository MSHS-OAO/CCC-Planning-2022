...
## Average Daily Census Analysis {.tabset}
...
kable(unit_type_total_adc_table,
      format = "html",
      escape = FALSE,
      align = "l",
      digits = 1,
  ...
  row_spec(row = 0,
           background = "#221f72",
           color = "white") %>%
  row_spec(row = nrow(unit_type_total_adc_table),
           bold = TRUE,
           italic = TRUE)
